  ...
  return (
    <div
      className={`flex items-center justify-between w-full p-8 mb-4 rounded-2xl shadow-lg transition-all ${
        task.completed
          ? "bg-gradient-to-r from-[#1C9B5E]/30 to-[#105735]/70 border border-[#1C9B5E]"
          : "bg-gradient-to-r from-[#DB5C61]/30 to-[#a43135]/70 border border-[#DB5C61]"
      }`}
    >
      <div className="flex items-center gap-4 py-6">
        ...
        <input
          ...
          className="w-6 h-6 cursor-pointer rounded border-2 border-[#1C9B5E] bg-[#01013D] checked:bg-[#1C9B5E] accent-[#1C9B5E] transition"
      ...
      <div className="flex gap-4 items-center flex-1">
        ...
        {/* Edit Button */}
        <div
          className={`${task.completed ? "opacity-0 pointer-events-none" : ""}`}
        >
          <button
            type="button"
